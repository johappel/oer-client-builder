...
- **Artikel & Nachrichten (30029, 1):** Titel/Name/Beschreibung sind wichtig; Öffnen-Link soll auf die passende URI (`nostr:naddr...` bzw. `nostr:nevent...`) zeigen.
...
- `src/lib/nostr/parser.ts`:
  ...
  - `ParsedEvent.nostrUri` wird pro Kind abgeleitet (31922/31923/30142/30023/30029 → `naddr`, 1 → `nevent`, 0 → `nprofile`).
